...
export const CORE_RESPONSE_SHAPE_INSTRUCTION = `Use this JSON shape exactly: {
  "rawPageSignals": string[],
  "buckets": {
    "clarity": {
      "what_it_is": { "status": "strong|okay|weak|missing", "confidence": number, "evidence": string[], "note": string },
...
export const PRESENTATION_RESPONSE_SHAPE_INSTRUCTION = `Use this JSON shape exactly: {
  "verdict": string,
  "summary": string,
  "problems": string[],
  "fixes": string[],
